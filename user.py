...
course_college = Table('course_college',Base.metadata,
                       Column('course_id',ForeignKey('course.id')),
                       Column('college_id',ForeignKey('college.id')))
...
class College(Base):
    ...
    courses = relationship('Course',secondary=course_college,back_populates='colleges')
...
class Course(Base):
    ...
    colleges = relationship('College', secondary=course_college, back_populates='courses')
